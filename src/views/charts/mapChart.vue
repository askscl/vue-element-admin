...
// import chinamap from "@/assets/mapChart/china.json";
export default {
    name: "mapChart",
    data() {
        return {
    ...
    mounted() {
        ...
        this.myChart = echarts.init(this.$refs.echart_china, "blue");
